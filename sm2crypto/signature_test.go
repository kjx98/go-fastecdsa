...
var (
	...
	testpubkey   = hexutil.MustDecode("0x049f839f7833dc7ffeb73432e999fe56623630db80673c1e19335e40d6f30fcc74bf321c7a7cce6e2e1b6092d4608e6f6784f49100322c29a53ae887f1a8fa914f")
	testpubkeySc = hexutil.MustDecode("0x039f839f7833dc7ffeb73432e999fe56623630db80673c1e19335e40d6f30fcc74")
	testpubkeyu  = hexutil.MustDecode("0x04e32df42865e97135acfb65f3bae71bdc86f4d49150ad6a440b6f15878109880af8dae65eb9b968966267bd7fd0db4b640bee4de9294f708eba114a6c8a42d8f0")
...
func TestVerifySignature(t *testing.T) {
	...
	if !VerifySignature(testpubkeySc, testmsg, sig) {
...
func TestDecompressPubkey(t *testing.T) {
	...
	if uncompressed := FromECDSAPub(key); !bytes.Equal(uncompressed, testpubkeyu) {
