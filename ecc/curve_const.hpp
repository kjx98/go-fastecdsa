...
constexpr u64 sm2_p256_p[] = { 0xFFFFFFFFFFFFFFFFull, 0xffffffff00000000ull,
				0xffffffffffffffffull, 0xfffffffeffffffffull,
				0x200000003, 0x200000002, 0x100000001, 0x100000001, 1};
constexpr u64 sm2_p256_n[] = { 0x53bbf40939d54123ull, 0x7203df6b21c6052bull,
				0xFFFFFFFFFFFFFFFFull, 0xfffffffeffffffffull };
constexpr bn_words sm2_p256_p_rr = { 0x200000003ull, 0x2ffffffffull,
				0x100000001ull, 0x400000002ull };
constexpr bn_words sm2_p256_n_rr = { 0x901192AF7C114F20ull, 0x3464504ADE6FA2FAull,
	   			0x620FC84C3AFFE0D4ull, 0x1EB5E412A22B3D3Bull };
constexpr u64 sm2_p256_k0_p = 1;
constexpr u64 sm2_p256_k0_n = 0x327f9e8872350975;
constexpr u64 sm2_p256_a[] = { 0xFFFFFFFFFFFFFFFCull, 0xffffffff00000000ull,
				0xffffffffffffffffull, 0xfffffffeffffffffull };
constexpr u64 sm2_p256_b[] = { 0xDDBCBD414D940E93ull, 0xF39789F515AB8F92ull,
				0x4D5A9E4BCF6509A7ull, 0x28E9FA9E9D9F5E34ull };
constexpr u64 sm2_p256_gx[]= { 0x715A4589334C74C7ull, 0x8FE30BBFF2660BE1ull,
			0x5F9904466A39C994ull, 0x32C4AE2C1F198119ull };
constexpr u64 sm2_p256_gy[]= { 0x2DF32E52139F0A0ull, 0xD0A9877CC62A4740ull,
